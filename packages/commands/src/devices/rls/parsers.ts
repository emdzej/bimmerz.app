...
import { KNOWN_COMMANDS, validateCommand, ParserRegistry } from "../../types";
...
export type RlsParsedCommandTypes = {
    [KNOWN_COMMANDS.LIGHT_RAIN_SENSOR_STATUS]: RainLightSensorStatus;
};

export const RLS_COMMAND_PARSERS: ParserRegistry<RlsParsedCommandTypes> = {
    [KNOWN_COMMANDS.LIGHT_RAIN_SENSOR_STATUS]: parseRainLightSensorStatus
} as const;
