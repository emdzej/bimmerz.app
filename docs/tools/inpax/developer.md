...
- Package layout — interpreter, parser, dispatcher, providers,
  web-provider components.
...
The [embedding guide in the repo](https://github.com/emdzej/inpax/blob/main/docs/guides/developer/embedding.md)
is the most complete reference today.
