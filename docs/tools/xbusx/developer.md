...
- Package layout — `@emdzej/ikbus-protocol`, `-commands`, `ibusx-core`,
  `-devices`, `-transport-*`.
- Citation conventions in the protocol reference (how to add or contest a
  claim).
...
The [`docs/` tree in the repo](https://github.com/emdzej/xbusx/tree/main/docs)
