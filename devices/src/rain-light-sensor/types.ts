...
export const RAIN_LIGHT_SENSOR_COMMANDS = {
    SENSOR_STATUS: 0x59,
} as const;

export type RAIN_LIGHT_SENSOR_COMMAND = typeof RAIN_LIGHT_SENSOR_COMMANDS[keyof typeof RAIN_LIGHT_SENSOR_COMMANDS];
