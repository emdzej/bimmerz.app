export const BODY_MODULE_DIAGNOSTIC_JOBS = {
...
export type BODY_MODULE_DIAGNOSTIC_JOB = typeof BODY_MODULE_DIAGNOSTIC_JOBS[keyof typeof BODY_MODULE_DIAGNOSTIC_JOBS];
...
export type BODY_MODULE_VARIANT = typeof BODY_MODULE_VARIANTS[keyof typeof BODY_MODULE_VARIANTS];
...
export type DorLidStatus = {
    doorLidStatuses: DoorLidStatuses;
    centralLockingStatus: CENTRAL_LOCKING_STATUS;
    interiorLightStatus: LAMP_STATUS;        
